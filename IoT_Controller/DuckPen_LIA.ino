...
const char* mqtt_system_topic = "cage/system";
...
void loop() {
  ...
  // Get the systemPin value here
  systemValue = digitalRead(systemPin);
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    String systemMessage = String(systemValue) ;
    client.publish("cage/system", systemMessage.c_str());
